package com.jack.geophoto.file;
...
public class FolderScanner
{
  ...
  public FolderScanner(String filter, boolean includeSubfolders)
  {
    this(FileSystems.getDefault().getPathMatcher(filter), includeSubfolders, null);

  }
  
  public FolderScanner(boolean includeSubfolders)
  {
    this("glob:*.*", includeSubfolders);
  }
